...
train_dataset_fp = "/home/tbreimer/forestquest.net/snowdayForecast/test/train.csv"
...
test_fp = "/home/tbreimer/forestquest.net/snowdayForecast/test/2017.csv"
...
test_fp = "/home/tbreimer/forestquest.net/snowdayForecast/test/test.csv"
...
for (x, y) in test_dataset:
  ...
  per = tf.compat.v1.math.softmax(logits).numpy()
  print("| 0: " + str(per[0][0]) + " 1: " + str(per[0][1]) + " 2: " + str(per[0][2]) + " 3: " + str(per[0][3]))
  print("| 0: " + str(per[1][0]) + " 1: " + str(per[1][1]) + " 2: " + str(per[1][2]) + " 3: " + str(per[1][3]))
  print("| 0: " + str(per[2][0]) + " 1: " + str(per[2][1]) + " 2: " + str(per[2][2]) + " 3: " + str(per[2][3]))
  print("| 0: " + str(per[3][0]) + " 1: " + str(per[3][1]) + " 2: " + str(per[3][2]) + " 3: " + str(per[3][3]))
  print("| 0: " + str(per[4][0]) + " 1: " + str(per[4][1]) + " 2: " + str(per[4][2]) + " 3: " + str(per[4][3]))
